        ...
        <div class="card-body">
            ...
            <form action="<?php echo base_url('product/update/'.$product->id) ?>" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" name="title" value="<?php echo $product->title ?>" class="form-control" id="exampleInputEmail1"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="slug" value="<?php echo $product->slug?>" class="form-control" id="exampleInputEmail1"
                        aria-describedby="emailHelp">
